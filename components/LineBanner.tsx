  ...
  return (
    <aside className="my-8 rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50 to-brand-100 p-5 sm:p-6">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-7 rounded-full shadow-sm transition-colors w-full sm:w-auto sm:inline-flex"
      >
