      ...
      <div className="sm:flex sm:items-center sm:gap-6">
        ...
        <div className="sm:shrink-0">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-7 rounded-full shadow-sm whitespace-nowrap transition-colors"
          >
